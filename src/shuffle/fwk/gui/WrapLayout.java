...
public class WrapLayout extends FlowLayout {
   ...
   /**
    * Returns the preferred dimensions for this layout given the component that needs to be laid
    * out.
    * 
    * @param target
    *           the Container which needs to be laid out
    * @return the preferred Dimensions for the given container.
    */
   @Override
   ...
   /**
    * Returns the minimum dimensions for this layout given the component that needs to be laid out.
    * 
    * @param target
    *           the Container which needs to be laid out
    * @return the minimum Dimensions for the given container.
    */
   @Override
